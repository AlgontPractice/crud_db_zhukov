...
def get_config_files():
    ...
    parser.add_argument(
        ...
        type=str,
        default='C:\projects\crud_db\crud_db.json')  # TODO: в проекте есть файл crud_db.json - его надо положить в папку, указанную тут. При необходимости каталог можно изменить
